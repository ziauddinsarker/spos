...
-- ----------------------------
INSERT INTO `tbl_customer` VALUES ('1', '', '', '', '', '8');
...
CREATE TABLE `tbl_inventory` (
  ...
  `inventory_product_left` int(11) DEFAULT NULL,
  `inventory_product_sold` int(11) DEFAULT NULL,
  `inventory_challan_number` varchar(255) DEFAULT NULL,
  `inventory_received_from` varchar(255) DEFAULT NULL,
  `inventory_add_user` int(11) DEFAULT NULL,
  `inventory_add_date` date DEFAULT NULL,
  `inventory_add_time` time DEFAULT NULL,
  `inventory_add_timestamp` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_product` (`inventory_product_id`),
  CONSTRAINT `fk_product` FOREIGN KEY (`inventory_product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of tbl_inventory
-- ----------------------------
INSERT INTO `tbl_inventory` VALUES ('1', '3', '45', '5', '012', 'factory', '8', null, null, '2016-02-18 16:54:39');
INSERT INTO `tbl_inventory` VALUES ('2', '27', '20', null, '023', 'Head Office', '8', null, null, null);
...
-- ----------------------------
INSERT INTO `tbl_orderdetail` VALUES ('1', '3', '5', '2250.00', '0', '0.00', '11250.00', '2016-02-18', 'SIN-180216-001-0001', null, '2016-02-18 16:54:39');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', '127.0.0.1', 'admin', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', null, null, null, null, '1268889823', '1455788786', '1', 'Admin', 'istrator', 'ADMIN', '0');
INSERT INTO `users` VALUES ('7', '::1', 'aslam', '$2y$08$2c4wydArnkhg3u8GGSmg/e7GrtV1OwO9TbdJA2bP4oHFWH24EF5Tm', null, 'designer@simuragroup.com', null, null, null, null, '1451381608', '1455787101', '1', 'Aslam', 'Uddin', 'SIMURA Non Wovens Ltd.', '017');
INSERT INTO `users` VALUES ('8', '::1', 'outlet1', '$2y$08$dMU1oTWxI87LSa2AkC5Hq.S3BoQ8RPCTeH.f.GHnlsKl4QmQa76Mq', null, 'outlet1@simuragroup.com', null, null, null, null, '1455704819', '1455793045', '1', 'Outlet 1', 'Aziz Super Market', 'SIMURA Non-Wovens Ltd.', '01720223388');
